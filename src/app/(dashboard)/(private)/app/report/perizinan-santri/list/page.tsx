...
import { fetchPerizinanSantriPage, postPerizinanExport } from '../../../perizinan-santri/slice'
  ...
  const content = (
    <>
      ...
      <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={() => setAnchorEl(null)}>
        <MenuItem
          component={Link}
          href={`/app/perizinan-santri/detail?id=${row.id_izin}&view=true`}
...
const PerizinanSantriReportList = () => {
  ...
  const buildTable = () => {
    ...
    return {
      ...
      fields: [
        ...
        tableColumn('LOKASI KAMAR', 'lokasi'),
  ...
  return (
    <Grid container spacing={6} sx={{ width: '100%' }}>
      ...
      <Grid size={12}>
        <Card>
          <CardHeader title='Laporan Perizinan Santri' sx={{ paddingBottom: 0 }} />
          <Toolbar
            sx={{
              px: '1.5rem !important',
              minHeight: 'auto',
...
export default PerizinanSantriReportList
