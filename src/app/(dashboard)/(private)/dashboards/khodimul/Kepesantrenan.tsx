...
const Component = ({ ...res }) => {
  ...
  }, [selectedKamar, startDate, endDate])
    ...
    <Grid container spacing={6}>
      ...
      <ScrollRow>
        <CRMCard
          ...
          chipColor='success'
          chipVariant='tonal'
          href={`/app/report/absen-harian-santri/list?status=Hadir&tanggal_mulai=${format(startDate || '', 'yyyy-MM-dd')}&tanggal_selesai=${format(endDate || '', 'yyyy-MM-dd')}`}
        />
        <CRMCard
          title='Absensi Izin'
          ...
          chipColor='info'
          chipVariant='tonal'
          href={`/app/report/absen-harian-santri/list?status=Izin&tanggal_mulai=${format(startDate || '', 'yyyy-MM-dd')}&tanggal_selesai=${format(endDate || '', 'yyyy-MM-dd')}`}
        />
        <CRMCard
          title='Absensi Sakit'
          ...
          chipColor='warning'
          chipVariant='tonal'
          href={`/app/report/absen-harian-santri/list?status=Sakit&tanggal_mulai=${format(startDate || '', 'yyyy-MM-dd')}&tanggal_selesai=${format(endDate || '', 'yyyy-MM-dd')}`}
        />
        <CRMCard
          title='Absensi Alfa'
          ...
          chipColor='error'
          chipVariant='tonal'
          href={`/app/report/absen-harian-santri/list?status=Alfa&tanggal_mulai=${format(startDate || '', 'yyyy-MM-dd')}&tanggal_selesai=${format(endDate || '', 'yyyy-MM-dd')}`}
        />
      </ScrollRow>
      <Grid size={12}>
        <Typography variant='h4' sx={{ fontWeight: 600, mt: 2 }}>
      ...
      <ScrollRow>
        <CRMCard
          ...
          avatarSkin='light'
          avatarSize={44}
          href={`/app/report/perizinan-santri/list?status=Menunggu&tanggal_mulai=${format(startDate || '', 'yyyy-MM-dd')}&tanggal_selesai=${format(endDate || '', 'yyyy-MM-dd')}`}
        />
        <CRMCard
          ...
          avatarSkin='light'
          avatarSize={44}
          href={`/app/report/perizinan-santri/list?status=Disetujui&tanggal_mulai=${format(startDate || '', 'yyyy-MM-dd')}&tanggal_selesai=${format(endDate || '', 'yyyy-MM-dd')}`}
        />
        <CRMCard
          ...
          avatarSkin='light'
          avatarSize={44}
          href={`/app/report/perizinan-santri/list?kondisi=Overdue&tanggal_mulai=${format(startDate || '', 'yyyy-MM-dd')}&tanggal_selesai=${format(endDate || '', 'yyyy-MM-dd')}`}
        />
      </ScrollRow>
    </Grid>
  )
